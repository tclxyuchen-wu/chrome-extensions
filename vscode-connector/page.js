(twod=>{
    (()=>{
        ...
        class t {
            ...
            async queryPermission(t={
                ...
                if (n.queryPermission)
                    return n.queryPermission(t);
                if ("read" === t.mode)
                    return "granted";
                if ("readwrite" === t.mode)
                    return n.writable ? "granted" : "denied";
            ...
            async isSameEntry(t) {
                return this === t || this.kind === t.kind && !!t[e] && await this[e].isSameEntry(t[e])
            }
        }
        ...
        const n = globalThis.WritableStream
          , r = globalThis.WritableStream || n;
        class i extends r {
            constructor(e, t) {
                super(e, t),
                this._closed = !1,
        ...
        class o extends t {
            ...
            async createWritable(e={}) {
                return new i(await this[s].createWritable(e))
            }
            async getFile() {
        ...
        class l extends t {
            ...
            async getDirectoryHandle(e, t={}) {
                ...
                return new l(await this[c].getDirectoryHandle(e, t))
            }
            getDirectory(e, t={}) {
            ...
            async*entries() {
                for await(const [,e] of this[c].entries())
                    yield[e.name, "file" === e.kind ? new o(e) : new l(e)]
            }
            async*getEntries() {
                return this.entries()
            }
            ...
            async getFileHandle(e, t={}) {
                ...
                if ("." === e || ".." === e || e.includes("/"))
                    throw new TypeError("Name contains invalid characters.");
                return t.create = !!t.create,
                new o(await this[c].getFileHandle(e, t))
            }
            getFile(e, t={}) {
        ...
        const d = l
          , h = globalThis.File
          , u = globalThis.Blob
          , {INVALID: f, GONE: p, MISMATCH: m, MOD_ERR: w, SYNTAX: y, DISALLOWED: g} = {
        ...
        class E {
            ...
            async write(e) {
                ...
                if ((e=>"object" == typeof e && void 0 !== e.type)(e))
                    if ("write" === e.type) {
                        if ("number" == typeof e.position && e.position >= 0 && (this.position = e.position,
                        this.size < e.position && (this.file = new h([this.file, new ArrayBuffer(e.position - this.size)],this.file.name,this.file),
                        ...
                        if ("seek" === e.type) {
                            if (Number.isInteger(e.position) && e.position >= 0) {
                                if (this.size < e.position)
                                    throw new DOMException(...f);
                        ...
                        if ("truncate" === e.type) {
                            if (Number.isInteger(e.size) && e.size >= 0)
                                return t = e.size < this.size ? new h([t.slice(0, e.size)],t.name,t) : new h([t, new Uint8Array(e.size - this.size)],t.name,t),
                                this.size = t.size,
        ...
        class b {
            ...
            async getFile() {
                if (this.deleted || null === this.file)
                    throw new DOMException(...p);
                return await this.file.get()
            }
            async createWritable(e) {
                if (!this.writable)
                    throw new DOMException(...g);
                if (this.deleted)
                    throw new DOMException(...p);
        ...
        class T {
            ...
            async getFileHandle(e, t={}) {
                ...
                if (t.create)
                    return this._entries[e] = new b(e);
                throw new DOMException(...p)
            }
            async removeEntry(e, t={}) {
                const n = this._entries[e];
        ...
        let M, x;
        const S = e=>{
            const {name: t, writeable: n=!0, eventEmitter: r, entries: i} = e;
            return M = new T(t,n),
            i && (M._entries = i),
            x = r,
            M
        }
          , {AbortController: O, FileReader: D, TextDecoder: k, addEventListener: H, atob: P, btoa: L, clearInterval: _, clearTimeout: I, crypto: N, decodeURIComponent: A, encodeURIComponent: F, escape: q, fetch: j, location: z, removeEventListener: C, setInterval: $, setTimeout: W, unescape: R} = self
          , {DOMParser: B, Notification: U, Image: Y, Worker: X, XMLHttpRequest: G, alert: J, confirm: V, document: K, localStorage: Q, screen: Z} = (self,
        z.origin,
        z.host,
        self)
          , ee = e=>new Promise((t=>re(t, e)));
        let te = 0;
        const ne = async function(e, ...t) {
          ...
          , re = function(e, t) {
            return t ? W.apply(this, [e, t]) : (ne.apply(this, [e]),
            0)
        }
          , ie = (e,t)=>{
          ...
          , se = (...e)=>{
            ...
            if ("function" == n)
                return "loading" != window.document.readyState ? t(null) : window.addEventListener("DOMContentLoaded", t),
                se([]);
            if ("string" == n) {
                let e = [];
                if ("<" == t.trim()[0]) {
            ...
            if ("array" == n) {
                const e = t
                  ...
                  , r = Object.assign(e, {
                    ...
                    ,
                    addClass: t=>(e.forEach((e=>e?.classList.add(t))),
                    se(e)),
                    removeClass: t=>(e.forEach((e=>e?.classList.remove(t))),
                    se(e)),
                    toggleClass: (t,n)=>(!0 === n ? r.addClass(t) : !1 === n ? r.removeClass(t) : e.forEach((e=>e?.classList.toggle(t))),
                    se(e)),
                    hasClass: t=>!!e.filter((e=>e?.classList.contains(t))).length,
                    is: t=>{
                        const n = e[0];
                        if (n)
                    ...
                    text: t=>{
                        if (e.length) {
                            if (void 0 === t)
                                return e.map((e=>e.innerText)).join("");
                    ...
                    html: t=>{
                        if (e.length) {
                            if (void 0 === t)
                                return e.map((e=>e.innerHTML)).join("");
                    ...
                    children: t=>{
                        ...
                        if (n)
                            if (t) {
                                ...
                                return se([].slice.call(n.children));
                        return se([])
                    }
                    ,
                    find: t=>{
                    ...
                    ,
                    each: t=>(e.forEach(((e,n)=>t(n, e))),
                    se(e)),
                    toArray: ()=>[...e],
                    bind: (t,i)=>(t.split(" ").forEach((t=>{
                        (n[t] || (n[t] = [])).push(i),
                        e.forEach((e=>e.addEventListener(t, i)))
                    }
                    )),
                    r),
                    unbind: t=>(t.split(" ").forEach((t=>{
                        n[t] && (n[t].forEach((n=>{
                            e.forEach((e=>{
                    ...
                    value: t=>{
                        if (void 0 === t) {
                            ...
                            return e.reverse().some((e=>{
                                if (!e.disabled)
                                    return "checkbox" != e.type || 1 == e.checked ? (t = e.value,
                                    !0) : void 0
                            }
                            )),
                            t
                        }
                        {
                            ...
                            n && ("checkbox" == n.type ? n.value == t && (n.checked = !0) : n.setAttribute("value", t))
                        }
                    }
                    ,
                    data: t=>{
                    ...
                    ,
                    get: t=>e[t],
                    on: (t,n)=>(t.split(" ").forEach((t=>e.forEach((e=>e?.addEventListener(t, n))))),
                    se(e)),
                    off: (t,n)=>(t.split(" ").forEach((t=>e.forEach((e=>e?.removeEventListener(t, n))))),
                    se(e)),
                    trigger: (t,...n)=>(e.forEach((e=>{
                        const r = e[t];
                        r && r.apply(e, n)
                    }
                    )),
                    se(e)),
                    toggle: t=>(e.forEach((e=>{
                        const n = se(e);
                    ...
                    animate: (t,n,r)=>{
                        const i = e[0];
                        return i.current_action && window.clearInterval(i.current_action),
                        i.current_action = window.setInterval((()=>{
                            if (void 0 !== t.scrollTop) {
                                const e = i === window ? document.documentElement : i
                                  , n = e.scrollTop;
                                e.scrollTop < t.scrollTop ? e.scrollTop = e.scrollTop + 3 : e.scrollTop = e.scrollTop - 3,
                                (e.scrollTop === n || Math.abs(e.scrollTop - t.scrollTop) <= 3) && (e.scrollTop = t.scrollTop,
        ...
        class he extends v {
            ...
            async get() {
                ...
                return this.cache?.lastModified && e.lastModified === this.cache.lastModified || (this.cache = e),
                this.cache
            }
            async set(e) {
                this.cache = e,
        ...
        (async e=>{
            ...
            const i = (({sendPrefix: e, listenPrefix: t, cloneInto: n})=>{
                ...
                const d = e=>{
                  ...
                  , h = (e,t)=>{
                    const {m: r, a: i, r: s, n: o} = t
                      , a = ((e,t,r)=>{
                        let i;
                        var s;
                        return r ? (i = ae("MutationEvent"),
                        i.initMutationEvent(e, !1, !1, r || null, void 0, void 0, JSON.stringify(t), MutationEvent.ADDITION)) : i = new CustomEvent(e,{
                            detail: (s = t,
                            n ? n(s, window.document) : s)
                        }),
                        i
                    }
                    )(e, {
                  ...
                  , u = t=>{
                    const {m: n, r: o, a: d} = (u = t)instanceof CustomEvent ? u.detail : JSON.parse(u.attrName);
                    var u;
                    if ("bridge.onpurge" == n)
                        (async()=>{
                            await null,
                            s !== window.document.documentElement && m.refresh()
                        }
                        )();
                    else if ("unlock" == n) {
                        c = !1;
                  ...
                  , f = e=>{
                    e && (i = e),
                    i && (s = window.document.documentElement,
                    addEventListener(`${t}_${i}`, u, !0))
                }
                ;
                let p = ()=>{}
                ;
                const m = {
                    init: async t=>{
                        ...
                        oe ? (s = document.documentElement,
                        p = ()=>{
                            s !== document.documentElement && (m.refresh(),
                            h(`${e}_${i}`, {
                                m: "unlock",
                                a: void 0,
                                r: null
                                ...
                                throw "not supported";
                            {
                                const t = new MutationObserver((n=>{
                                    ...
                                    )(e.addedNodes, document.documentElement))) && (e(document),
                                    t.disconnect())
                                }
                                ));
                                t.observe(document, {
                    ...
                    ,
                    cleanup: ()=>{
                        i && (removeEventListener(`${t}_${i}`, u, !0),
                        s = void 0,
                        i = void 0)
                    }
                };
            ...
            e.showDirectoryPicker = async()=>{
                ...
                for (; e++ < 50 && !r; )
                    await ee(100);
                if (!r)
                    throw alert("No extension is there to communicate."),
                    new DOMException("No extension is there to communicate.");
                return r
            }
            ;
            const s = await (e=>new Promise((t=>{
                let n = 1;
                const r = ()=>{
                    e.send("userscripts", {
                        action: "list"
            ...
            !async function(e, t, n) {
                for (const {path: r, name: i, namespace: s, requires: o, storage: a} of t)
                    [r, a, ...o].filter((e=>e)).forEach((t=>{
                        const [,r,...o] = t.split("/")
                          , a = [fe(s || "<namespace missing>"), fe(i)];
                        "external" === r && a.push(r);
                        const c = a.reduce(((e,t)=>(e._entries[t] || (e._entries[t] = new T(t,!1)),
                        e._entries[t])), e)
                          , l = "source" === r ? "script.user.js" : "storage" === r ? "storage.json" : o && o.length ? fe(decodeURIComponent(o.join("/"))) : "<name missing>"
                          , d = new he(l,t,n);
                        c._entries[l] = new b(l,d,!0)
                    }
                    ));
                new d(e)
            }(o, s, {
                get: async(e,t,n)=>await me((async()=>{
                    const {value: r, lastModified: s} = await ((e,t,n)=>new Promise(((r,i)=>{
                        const s = setTimeout((()=>i(new DOMException(de))), 15e3);
                        e.send("userscripts", {
                            action: "get",
                            path: t,
                            ifNotModifiedSince: n
                        }, (e=>{
                            if (clearTimeout(s),
                            e && !le(e) && e.lastModified) {
                ...
                set: async(e,t,n)=>await me((async()=>{
                    await ((e,t,n,r)=>new Promise(((i,s)=>{
            ...
            r = await async function(e, t={}) {
                if (!e) {
                    if (!globalThis.navigator?.storage && "http:" === globalThis.location?.protocol)
                ...
                const n = await e
                  , r = "function" == typeof n ? await n(t) : await n.default(t);
                return new l(r)
            }(S, {
                name: "tc",
                eventEmitter: c,
            ...
            t.FileSystemDirectoryHandle = d,
            t.FileSystemFileHandle = a,
            t.Worker = new Proxy(n,{
                construct: (e,[t,r])=>{
                    const i = new n(t,r);
                    let s;
                    return new Proxy(i,{
                        get: (e,t)=>"postMessage" === t ? e=>{
                            const {method: t} = e;
                        ...
                        : ["addEventListener", "removeEventListener", "terminate"].includes(t) ? "addEventListener" === t ? (e,t)=>"message" === e ? (s = t,
                        i.addEventListener(e, (e=>{
                            s && s(e)
                        }
                        ))) : i.addEventListener(e, t) : i[t].bind(i) : Reflect.get(e, t),
                        set: (e,t,n)=>"onmessage" === t && "function" == typeof n ? (s = n,
                        i.onmessage = e=>s && s(e)) : Reflect.set(e, t, n)
                    })
                }
            }),
            se((()=>{
                const e = setInterval((()=>{
                    ...
                    if (!t) {
                        const e = se(".monaco-text-button")
                          , n = e.text();
                        "string" == typeof n && -1 != n.indexOf("Open Folder") && (t = e[0])
                    }
                    t && (t.click(),
